<aside class="w-full bg-gray-800 md:w-64 md:min-h-screen" x-data="{ isOpen: false }">
    <div class="flex items-center justify-between h-16 p-4 bg-gray-900">
        <a href="{{ route('dashboard')}}" class="flex items-center">
            ...
            <span class="mx-2 text-xl font-semibold text-gray-300">TMA Parking</span>
        </a>
    ...
    <div class="px-2 py-6 md:block" :class="isOpen? 'block': 'hidden'" >
        <ul>
            ...
            <li class="px-2 py-3 mt-2 rounded hover:bg-gray-900">
                <a href="{{route('parking.index')}}" class="flex items-center">
                    <svg class="w-6 text-gray-500" fill="none" stroke-linecap="round"
                         stroke-linejoin="round"
                         stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path
                    ...
                    <span class="mx-2 text-gray-300">Parkings</span>
                </a>
            </li>
            {{-- <li class="px-2 py-3 mt-2 rounded hover:bg-gray-900">
            ...
            <div x-data="{ isOpen:false }">
                <li
                    class="px-2 py-3 mt-2 rounded ">
                    <a role="button"
                        @click="isOpen = !isOpen" class="flex items-center">
                        <svg class="w-6 text-gray-500" fill="none" stroke-linecap="round"
                             stroke-linejoin="round"
                             stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path
                ...
                <div x-show="isOpen" class="pl-6 ml-3 text-sm text-gray-500 border-l border-gray-500">
                    <ul class="">
                        <li class="pl-1 hover:bg-gray-900">
                            <a href="{{route('report.daily')}}" >Daily</a>
                        </li>
                        <li class="pl-1 mt-2 hover:bg-gray-900">
                            <a href="{{route('report.monthly')}}" >Monthly</a>
                        </li>
                        <li class="pl-1 mt-2 hover:bg-gray-900">
                            <a href="{{route('report.datewise')}}">Datewise</a>
                        </li>
                    </ul>
                </div>
            </div>
